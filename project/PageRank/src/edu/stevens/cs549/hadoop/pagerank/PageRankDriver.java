...
public class PageRankDriver {
	...
	public static final double MAX_DIFFERENCE = 30;
	public static final double MAX_OUTPUT = 50;
	//public static final String CACHE_DIR = "/Users/tengfei/Desktop/Wen_Zhang/projectpackages/PageRank-1.0.0/cache";
	///Users/tengfei/Desktop/Wen_Zhang/projectpackages/PageRank-1.0.0/cache
	//public static final String CACHE_DIR = "/cache"; 
	
//	public static final String CACHE_DIR = "/cache";  // for local
	public static final String CACHE_DIR = "s3://pagerank-cs549/cache"; // for EMR
	
	public static final String CURRENT_PATH = System.getProperty("user.dir");
//	public static final String CACHE_DIR = "hdfs:/haddo
	
	
//	public static void mainA(String[] args) throws Exception {
//		summarizeResult("D:\\Project\\Java\\CS549\\pagerank\\pageranksrc\\output");
//	}
	...
	static void diff(String input1, String input2, String output, int reducers)
		...
		if (job.waitForCompletion(true)) // Once the first job completes
		{
			...
			System.out.println(job1.waitForCompletion(true) ? "Diff Job Completed"
							: "Diff Job Error");
//			deleteDirectory(CURRENT_PATH + "/tempdiff"); // Deletes the temporary directory "tempdiff"
	...
	static void finishJoin(String input, String output, int reducers)
		...
		FileInputFormat.addInputPath(job, new Path(CACHE_DIR)); // Adds input for 
		FileOutputFormat.setOutputPath(job, new Path(tempJoinFolder));

		job.setMapperClass(FinJoinMapper.class); // Sets Mapper and Reducer Classes
...
//		deleteDirectory(CURRENT_PATH + "/tempJoin"); // Deletes the input directory
	...
	public static void composite(String input, String output, String interim1,
		 ...
		 * TODO 
		 */
		System.out.println("Tengfei Yang (10395116)");
...
//				deleteDirectory(CURRENT_PATH + "/diffout"); // deletes diffout
		...
		if (fs.exists(finpath)) {
			...
			try {
				...
				for (int i = 0; i < nodes.length && i < MAX_OUTPUT; i++) {
					//String out = nodes[i] + ":" + nodeNames.get(nodes[i]) + "\t" + ranks[i] + "\n"; 
